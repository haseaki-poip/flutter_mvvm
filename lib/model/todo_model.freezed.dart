...
abstract class $TodoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime date, String todo, bool isCompleted});
}
...
class _$TodoModelImpl implements _TodoModel {
  const _$TodoModelImpl(
      {required this.date, required this.todo, this.isCompleted = false});
  ...
  @override
  String toString() {
    return 'TodoModel(date: $date, todo: $todo, isCompleted: $isCompleted)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, date, todo, isCompleted);
